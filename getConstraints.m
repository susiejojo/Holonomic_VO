function [vo,ceq] = getConstraints(agent_velo,agent_pos,sensedObstacles,agent_rad,obst_velo,obst_rad,time_sample)
    ...
    for i = 1:sensedobst_len(1)
        ...
        cone_tip = agent_pos + obst_velo*time_sample;
        ...
        c1 =  agent_new_pos(2) - (tan(cone_angle_left)*(agent_new_pos(1)-cone_tip(1))+cone_tip(2));
        c2 =  agent_new_pos(2) - (tan(cone_angle_right)*(agent_new_pos(1)-cone_tip(1))+cone_tip(2));
